...
export default function LandingPage() {
  ...
  <h2 className="text-2xl font-bold text-pink-700">Beauty Tips & Tricks</h2>
  <p className="text-lg text-pink-600 mt-4">Discover easy, fun, and effective beauty tips tailored for everyone!</p>
  <ul className="mt-6 text-pink-700 space-y-3 text-base">
    <li>💄 How to create the perfect dewy skin look in under 10 minutes</li>
    <li>🌸 Quick hacks to make your lipstick last all day</li>
    <li>✨ 5 ways to refresh your makeup routine this season</li>
    <li>🧴 Must-have skincare steps before applying makeup</li>
  </ul>
  <br /><br /><br /><br /><br /><br />
</section>
