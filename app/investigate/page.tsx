...
export default function LandingPage() {
  ...
  <h2 className="text-2xl font-bold text-pink-700">Investigate Beauty Trends</h2>
  <p className="text-lg text-pink-600 mt-4">Take a deeper look into the beauty world and what’s trending right now.</p>
  <ul className="mt-6 text-pink-700 space-y-3 text-base">
    <li>🔍 Viral TikTok makeup techniques: Do they actually work?</li>
    <li>📊 What products are Irish influencers loving this month?</li>
    <li>🧪 Ingredient spotlight: The truth about Hyaluronic Acid</li>
    <li>🗞️ Breaking down the latest beauty brand launches</li>
  </ul>
  <br /><br /><br /><br /><br /><br />
</section>
      </main>
